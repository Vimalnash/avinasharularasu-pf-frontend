...
export function ProjectCard(props) {
    const {theme, setLoadingTrue} = UseAppContext();
    const navigate = useNavigate();

    return (
        <div className="w-full border-[3px] border-teal-200 flex flex-col rounded-xl transition-all ease-in-out duration-300 shadow-xl hover:shadow-[0px_0px_5px_5px_#2dd4bf] lg:w-[300px]">
            <div className="">
